...
public interface IngredientDAO {
  ...
  //public Map<String, Integer> left_ingredient(); // 현재 재고 확인
	public List<IngredientDTO> leftingredient(); // 현재 재고 확인
  ...
  //public int add_ingredient(String ingredient, int qty, String vendor)throws SQLException; // 재고 추가 주문
	public int add_ingredient(IngredientDTO dto) throws SQLException; // 재고 추가 주문
	
	
  //public int sub_ingredient(Number ingredient, int qty, String vendor)throws SQLException; // 재고 삭제
	public int sub_ingredient(IngredientDTO dto) throws SQLException; // 재고 삭제
} 